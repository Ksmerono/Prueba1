<html>
 ...
 <body>
<?php echo '<h1>Harry Porlotes y El Prisionero del Firewall avanzado</h1>'; ?>
<?php print("<p>Un supuesto hacker maligno se salta el Firewall de la escuela y siembra el kernel panic.</p>
